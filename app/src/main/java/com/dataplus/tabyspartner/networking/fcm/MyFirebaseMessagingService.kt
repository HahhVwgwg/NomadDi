package com.dataplus.tabyspartner.networking.fcm
...
class MyFirebaseMessagingService : FirebaseMessagingService() {
    ...
    private fun sendNotification(messageBody: String) {
        ...
        val notificationBuilder = NotificationCompat.Builder(this, channelId)
            .setSmallIcon(R.drawable.ic_baseline_credit_card_24)
        ...
        notificationManager.notify(10003 /* ID of notification */, notificationBuilder.build())
    }
